...
function DetalheProduto(props){
    ...
    <View style={styles.headerTextos}>
        ...
        <Text style={styles.descricao}>Massa artesal , mussarela e calabresa serve de 3 a 4
             pessoas Molho e tomate 100% natural e ingredientes selecionados:</Text>
        <Text style={styles.valor}>R$ 65,00</Text>
    </View>
      </View>
      ...
      <View style={styles.footer}>
       ...
       <View style={styles.footerBtn}>
        {/* <Buttom style={styles.button} texto="Inserir"/> */}
        <Button style={styles.button} texto="Inserir"/>
      </View>
      </View>
    </View>
}
